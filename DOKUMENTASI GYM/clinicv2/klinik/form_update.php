...
include ('config.php');
$id_kad=$_GET['id'];
$ambil=mysql_query("SELECT *FROM form where id_kad='$id_kad'");
...
<table width="510" border="0">
  ...
  <form action="Pros_update.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $data['id_kad'];?>">
...
<tr>
  ...
  <th scope="col"><div align="left">
  <input type="text" name="nokp" value="<?php echo $data['nokp'];?>">
  </div>
  </th>
  </tr>
    <tr>
  ...
  <th scope="col"><div align="left">
  <input type="text" name="jantina" value="<?php echo $data['jantina'];?>">
  </div>
  </th>
  </tr>
    <tr>
  ...
  <th scope="col"><div align="left">
  <input type="date" name="tarikh" value="<?php echo $data['tarikh'];?>">
  </div>
  </th>
  </tr>
